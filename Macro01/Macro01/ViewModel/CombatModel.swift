...
//    var cards = Cards()
    ...
    @Published var mediumDiff = DifficultyModel(imageInitial: "intermediario", imageSillhoute: "intermediario", imageWin: "easyWin", winCard: "", selectdedLevel: false, winLevel: false)
